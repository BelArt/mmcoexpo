...
final class Constants
{
    ...
    const CATALOG_MMSO_CLEANING_FLOOR_OLD_PRICE                          = 584935;
    const CATALOG_MMSO_CLEANING_CARPET_OLD_PRICE                         = 584933;
    const CATALOG_MMSO_ELECTRO_32_OLD_PRICE                              = 584925;
    const CATALOG_MMSO_SOCKET_220_OLD_PRICE                              = 584877;
    const CATALOG_MMSO_SOCKET_ALONE_OLD_PRICE                            = 584879;
    const CATALOG_MMSO_SWITCHBOARD_50_OLD_PRICE                          = 584923;
    const CATALOG_MMSO_PROJECTOR_150W_OLD_PRICE                          = 584881;
    const CATALOG_MMSO_PROJECTOR_300W_OLD_PRICE                          = 584885;
    const CATALOG_MMSO_SPOT_BRA_100W_OLD_PRICE                           = 584887;
    const CATALOG_MMSO_LAMP_40W_OLD_PRICE                                = 584889;
    const CATALOG_MMSO_WALL_ELEMENT_05_OLD_PRICE                         = 584787;
    const CATALOG_MMSO_WALL_ELEMENT_075_OLD_PRICE                        = 584789;
    const CATALOG_MMSO_WALL_ELEMENT_1_OLD_PRICE                          = 584791;
    const CATALOG_MMSO_WALL_ELEMENT_15_OLD_PRICE                         = 584793;
    const CATALOG_MMSO_WALL_ELEMENT_WITH_GLASS_05_OLD_PRICE              = 584795;
    const CATALOG_MMSO_WALL_ELEMENT_WITH_GLASS_1_OLD_PRICE               = 584797;
    const CATALOG_MMSO_WALL_ELEMENT_WITH_CURTAIN_OLD_PRICE               = 584799;
    const CATALOG_MMSO_DOOR_BLOCK_WITH_STANDART_DOOR_OLD_PRICE           = 584801;
    const CATALOG_MMSO_DOOR_BLOCK_WITH_SLIDING_DOOR_OLD_PRICE            = 584785;
    const CATALOG_MMSO_STAND_OLD_PRICE                                   = 584803;
    const CATALOG_MMSO_BOARD_LDSP_03_OLD_PRICE                           = 584805;
    const CATALOG_MMSO_SHELF_LDSP_1_OLD_PRICE                            = 584807;
    const CATALOG_MMSO_FLOOR_LIFT_OLD_PRICE                              = 584813;
    const CATALOG_MMSO_ADDITIONAL_CARPETING_OLD_PRICE                    = 584811;
    const CATALOG_MMSO_INFORMATION_DESK_R1_OLD_PRICE                     = 584815;
    const CATALOG_MMSO_INFORMATION_STAND_WITH_SHELF_OLD_PRICE            = 584817;
    const CATALOG_MMSO_PODIUM_TABLE_1M_OLD_PRICE                         = 584819;
    const CATALOG_MMSO_PODIUM_TABLE_05M_OLD_PRICE                        = 584821;
    const CATALOG_MMSO_DOORS_PODIUM_TABLE_OLD_PRICE                      = 584809;
    const CATALOG_MMSO_LOW_SHOWCASE_OLD_PRICE                            = 584823;
    const CATALOG_MMSO_HIGH_SHOWCASE_OLD_PRICE                           = 584825;
    const CATALOG_MMSO_SOFT_CHAIR_OLD_PRICE                              = 584827;
    const CATALOG_MMSO_ROUND_TABLE_OLD_PRICE                             = 584831;
    const CATALOG_MMSO_SQUARE_TABLE_67CM_OLD_PRICE                       = 584833;
    const CATALOG_MMSO_RECTANGULAR_TABLE_100CM_OLD_PRICE                 = 584835;
    const CATALOG_MMSO_ROUND_GLASS_TABLE_OLD_PRICE                       = 584837;
    const CATALOG_MMSO_BAR_TABLE_LDSP_OLD_PRICE                          = 584839;
    const CATALOG_MMSO_METAL_STAND_3_SHELF_OLD_PRICE                     = 584841;
    const CATALOG_MMSO_PLASTIC_STAND_5_SHELF_OLD_PRICE                   = 584843;
    const CATALOG_MMSO_COFFEE_MACHINE_OLD_PRICE                          = 584869;
    const CATALOG_MMSO_LEATHER_SOFA_WHITE_OLD_PRICE                      = 584871;
    const CATALOG_MMSO_LEATHER_CHAIR_WHITE_OLD_PRICE                     = 584873;
    const CATALOG_MMSO_ARCHIVE_CUPBOARD_OLD_PRICE                        = 584845;
    const CATALOG_MMSO_LIST_HOLDER_STANDARD_OLD_PRICE                    = 584847;
    const CATALOG_MMSO_LIST_HOLDER_ROTATING_OLD_PRICE                    = 584849;
    const CATALOG_MMSO_WALL_HANGER_OLD_PRICE                             = 584851;
    const CATALOG_MMSO_FLOOR_HANGER_OLD_PRICE                            = 584853;
    const CATALOG_MMSO_PAPER_BASKET_OLD_PRICE                            = 584855;
    const CATALOG_MMSO_WATER_COOLER_19L_OLD_PRICE                        = 584865;
    const CATALOG_MMSO_EXTRA_BOTTLE_WATER_OLD_PRICE                      = 584867;
    const CATALOG_MMSO_TV_42_OLD_PRICE                                   = 584857;
    const CATALOG_MMSO_TV_50_OLD_PRICE                                   = 584859;
    const CATALOG_MMSO_TV_60_OLD_PRICE                                   = 584861;
    const CATALOG_MMSO_FLOOR_STAND_TV_OLD_PRICE                          = 584863;
    const CATALOG_MMSO_GLASS_COFFEE_TABLE_OLD_PRICE                      = 584875;
    const CATALOG_MMSO_COLORED_PASTING_STAMP_OLD_PRICE                   = 584963;
    const CATALOG_MMSO_COLORED_PASTING_STAMP_INFORMATION_DESK_OLD_PRICE  = 584903;
    const CATALOG_MMSO_COLORED_PASTING_ORACAL_WALL_PANEL_OLD_PRICE       = 584965;
    const CATALOG_MMSO_COLORED_PASTING_ORACAL_INFORMATION_DESK_OLD_PRICE = 584891;
    const CATALOG_MMSO_PASTING_OWN_MATERIAL_OLD_PRICE                    = 584893;
    const CATALOG_MMSO_CLEANING_PANEL_FROM_MATERIAL_OLD_PRICE            = 584909;
    const CATALOG_MMSO_INSCRIPTION_FRIEZE_1_LETTER_OLD_PRICE             = 584895;
    const CATALOG_MMSO_BANNER_TILL_3M_OLD_PRICE                          = 584897;
    const CATALOG_MMSO_BANNER_FROM_3M_OLD_PRICE                          = 584899;
    const CATALOG_MMSO_BANNER_INSTALLATION_OLD_PRICE                     = 584901;
    const CATALOG_MMSO_SINGLE_COLOR_LOGO_INFORMATION_DESK_OLD_PRICE      = 584905;
    const CATALOG_MMSO_SINGLE_COLOR_LOGO_WALL_PANEL_OLD_PRICE            = 584967;
    const CATALOG_MMSO_MULTICOLOR_COLOR_LOGO_INFORMATION_DESK_OLD_PRICE  = 584907;
    const CATALOG_MMSO_MULTICOLOR_LOGO_WALL_PANEL_OLD_PRICE              = 584969;
    const CATALOG_MMSO_PRODUCING_EVENTS_OLD_PRICE                        = 565137;
